...
public class STD430Writer {
    ...
    public static final Map<Class<?>, Integer> SIZES = new IdentityHashMap<Class<?>, Integer>();
        static {
    ...
    public static final Map<Class<?>, Integer> ALIGNMENTS = new IdentityHashMap<Class<?>, Integer>();
        static {
    ...
    public static <T> void writeField(Field f, T obj, DynamicByteBuffer bb) throws IllegalArgumentException, IllegalAccessException {
            Class<?> t = f.getType();
            if (t == int.class)
